...
function NavBar() {
  ...
  return (
      <nav className="sticky top-4 bg-violet-950 bg-opacity-30 backdrop-blur-lg rounded-2xl px-5 py-3 self-center flex w-full  items-start justify-between gap-5 mb-px max-md:max-w-full max-md:flex-wrap " >
          <img
              loading="lazy"
          ...
          <div className="self-center flex w-[691px] max-w-full items-start justify-between gap-5 my-auto max-md:flex-wrap max-md:justify-center">
              ...
              >
                  <span className={`${url == 'Home' ? 'bg-[20%]' : 'bg-[80%]'} justify-center bg-no-repeat transition-[background] duration-700 ease-in-out bg-[url('./whitevioletbg.jpg')] bg-clip-text text-transparent hover:bg-[20%]`}>Home</span>
              </button>
                </Link> 
              ...
              <button
                  ...
                  className="text-center text-lg font-semibold"
              >
                      <span className={`${url == 'About Me' ? 'bg-[20%]' : 'bg-[80%]'} justify-center bg-no-repeat transition-[background] duration-700 ease-in-out bg-[url('./whitevioletbg.jpg')] bg-clip-text text-transparent hover:bg-[20%]`}>About Me</span>
              </button>
                </Link>
              ...
              <button
                  ...
                  className="text-center text-lg font-semibold"
              >
                  <span className={`${url == 'Projects' ? 'bg-[20%]' : 'bg-[80%]'} justify-center bg-no-repeat transition-[background] duration-700 ease-in-out bg-[url('./whitevioletbg.jpg')] bg-clip-text text-transparent hover:bg-[20%]`}>Projects</span>
              ...
              <button
                  ...
                  className="text-center text-lg font-semibold"
              >
                  <span className={`${url=='Skills'?'bg-[20%]':'bg-[80%]'} justify-center bg-no-repeat transition-[background] duration-700 ease-in-out bg-[url('./whitevioletbg.jpg')] bg-clip-text text-transparent hover:bg-[20%]`}>Skills</span>
